...
import dk.dbd.assignment3.generated.valuedomains.JsonBoolean;
import dk.dbd.assignment3.generated.valuedomains.JsonNull;
import dk.dbd.assignment3.generated.valuedomains.JsonNumber;
import dk.dbd.assignment3.generated.valuedomains.JsonObjectList;
import dk.dbd.assignment3.generated.valuedomains.JsonString;
import dk.dbd.assignment3.generated.valuedomains.external.EDMA_ExternalConstraints;
import dk.dbd.assignment3.generated.valuedomains.impl.JsonObjectImpl;
...
{
    protected static final IMetaValueDomain edma_domain = Assignment3EDMA.environment.getValueDomainDefinitions().getValueDomain(5);
    ...
    /**
     * Creates a new JsonObject with the internal value domain JsonObjectList
     * @param jsonObjectList  The internal value that this JsonObject will get
     * @return                The created value
     */
    public static JsonObject create(JsonObjectList jsonObjectList)
    {
        Object[] edma_pair = new Object[2];
        edma_pair[0] = 0;
        edma_pair[1] = ((IValueInstance) jsonObjectList).edma_getValue();
     ...
     *          JsonObjectList
     */
    public abstract boolean isJsonObjectList();
    ...
    /**
     * Returns this value as a value from the value domain JsonObjectList or
     * throws an UnsupportedOperationException if this value is not from the
     * value domain JsonObjectList
     * @return  This value as a value from the value domain JsonObjectList
     */
    public abstract JsonObjectList asJsonObjectList();
