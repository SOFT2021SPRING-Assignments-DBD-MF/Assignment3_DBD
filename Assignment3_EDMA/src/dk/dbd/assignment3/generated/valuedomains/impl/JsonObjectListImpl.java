...
/**
 * The implementation of JsonObjectList
 */
public class JsonObjectListImpl extends JsonObjectList implements IValueInstance
{
     ...
     */
    public JsonObjectListImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    /**
     * Compare this JsonObjectList to another JsonObjectList
     * @param jsonObjectList  The JsonObjectList to compare with
     * @return                A negative integer, zero, or a positive integer
     *                        as this JsonObjectList is less than, equal to, or
     *                        greater than the specified JsonObjectList
     */
    public int compareTo(JsonObjectList jsonObjectList)
    {
        return edma_domain.valueCompare(value, ((JsonObjectListImpl) jsonObjectList).value);
    }
    ...
    {
        return new JsonObjectListIterator();
    }
     ...
     * 
     */
    public class JsonObjectListIterator implements Iterator<Member>
    {
        private int pos;
