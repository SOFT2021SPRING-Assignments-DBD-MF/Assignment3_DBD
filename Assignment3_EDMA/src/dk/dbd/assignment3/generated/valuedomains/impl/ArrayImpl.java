...
public class ArrayImpl extends Array implements IValueInstance
{
     ...
     */
    public Iterator<JsonObjectList> iterator()
    {
     ...
     */
    public JsonObjectList get(int index)
    {
        return new JsonObjectListImpl(value[index]);
    }
     ...
     * 
     */
    public class ArrayIterator implements Iterator<JsonObjectList>
    {
        private int pos;
         ...
         */
        public JsonObjectList next()
        {
            return new JsonObjectListImpl(value[pos++]);
        }
