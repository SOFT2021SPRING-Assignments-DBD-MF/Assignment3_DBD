...
import dk.dbd.assignment3.generated.valuedomains.JsonObject;
...
import dk.dbd.assignment3.generated.valuedomains.impl.ArrayImpl;
import dk.dbd.assignment3.generated.valuedomains.impl.JsonBooleanImpl;
import dk.dbd.assignment3.generated.valuedomains.impl.JsonNullImpl;
import dk.dbd.assignment3.generated.valuedomains.impl.JsonNumberImpl;
import dk.dbd.assignment3.generated.valuedomains.impl.JsonObjectListImpl;
import dk.dbd.assignment3.generated.valuedomains.impl.JsonStringImpl;
...
public class JsonObjectImpl extends JsonObject implements IValueInstance
{
     ...
     *          JsonObjectList
     */
    public boolean isJsonObjectList()
    {
     ...
     */
    public JsonObjectList asJsonObjectList()
    {
        Integer index = (Integer) value[0];
        if(index.intValue() != 0) throw new UnsupportedOperationException();
        return new JsonObjectListImpl(value[1]);
    }
