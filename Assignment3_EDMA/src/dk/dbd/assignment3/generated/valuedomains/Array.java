...
import dk.dbd.assignment3.generated.valuedomains.impl.ArrayBuilderImpl;
 ...
 */
public abstract class Array implements Comparable<Array>, Iterable<JsonObjectList>
{
    protected static final IMetaValueDomain edma_domain = Assignment3EDMA.environment.getValueDomainDefinitions().getValueDomain(8);
     ...
     */
    public abstract JsonObjectList get(int index);
    ...
    public interface ArrayBuilder
    {
         ...
         * @return                An interface to the builder for chaining
         *                        method calls
         */
